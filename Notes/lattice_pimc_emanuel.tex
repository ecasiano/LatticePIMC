...
&= -\sum_{\alpha_0, \alpha_1} C_{\alpha_0} C_{\alpha_1}^{*}  \int_{0}^{\beta} d\tau_1 e^{-\epsilon_{\alpha_0}(\beta-\tau_1)} e^{-\epsilon_1 \tau_1}  \bra{\alpha_0} H_1 \ket{\alpha_1}
\end{aligned}
\end{equation}

%e^{\tau_1 H_0}H_1e^{-\tau_1 H_0} 
%e^{-\epsilon_{\alpha_0}(\beta-\tau_1)} e^{-\epsilon_1(\tau_1-\tau_2)} e^{-\epsilon_2 \tau_2}
...
\mathcal{Z}_T^{(2)} &= \sum_{\alpha_0, \alpha_1, \alpha_2} C_{\alpha_0} C_{\alpha_2}^{*} \int_0^{\beta} d\tau_1 \int_{0}^{\tau_1} d\tau_2 e^{-\epsilon_{\alpha_0}(\beta-\tau_1)} e^{-\epsilon_1(\tau_1-\tau_2)} e^{-\epsilon_2 \tau_2} \bra{\alpha_0} H_1 \ket{\alpha_1} \bra{\alpha_1} H_1 \ket{\alpha_2}
\end{aligned}
\end{equation}
...
%
\begin{equation}
\bra{\alpha_p} H_1^{(worm)} \ket{\alpha_q} =  \sum_i\eta_i \sqrt{n_i + 1} \delta_{m_i,n_{i}+1}  + \eta_i^* \sqrt{n_i} \delta_{m_i,n_{i}-1}  \prod_{k\neq i} \delta_{m_k,n_k}
\end{equation}
%
% -------------- Metropolis Sampling --------------- %
